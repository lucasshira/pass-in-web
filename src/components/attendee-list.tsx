      ...
      <div className="flex gap-3 items-center">
        ...
        <div className="px-3 w-72 py-1.5 border border-white/10 rounded-lg flex items-center gap-3">
          ...
          <input 
            ...
            value={search}
            className="bg-transparent flex-1 outline-none h-auto border-0 p-0 text-sm focus:ring-0" type="text" placeholder="Buscar participante" 
          />
        </div>
      </div>
        ...
        <tbody>
          {attendees.map((attendee) => {
            return (
              ...
              <TableCell>{dayjs().locale('pt-br').to(attendee.createdAt)}</TableCell>
